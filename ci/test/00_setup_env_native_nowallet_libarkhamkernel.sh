...
export CONTAINER_NAME=ci_native_nowallet_libarkhamkernel
...
export GOAL="install"
export ARKHAM_CONFIG="-DREDUCE_EXPORTS=ON -DBUILD_UTIL_CHAINSTATE=ON -DBUILD_KERNEL_LIB=ON -DBUILD_SHARED_LIBS=ON"
