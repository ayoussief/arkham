...
#ifndef ARKHAM_INTERFACES_INIT_H
#define ARKHAM_INTERFACES_INIT_H
...
//! (arkham-gui, arkham-node, arkham-wallet, arkhamd, arkham-qt) and each
...
#endif // ARKHAM_INTERFACES_INIT_H
