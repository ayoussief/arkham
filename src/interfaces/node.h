...
#ifndef ARKHAM_INTERFACES_NODE_H
#define ARKHAM_INTERFACES_NODE_H
...
//! Top-level interface for a arkham node (arkhamd process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or arkham.conf.
...
#endif // ARKHAM_INTERFACES_NODE_H
