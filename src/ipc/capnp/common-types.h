...
#ifndef ARKHAM_IPC_CAPNP_COMMON_TYPES_H
#define ARKHAM_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between arkham processes.
...
//! Functions to serialize / deserialize common arkham types.
namespace mp {
...
#endif // ARKHAM_IPC_CAPNP_COMMON_TYPES_H
