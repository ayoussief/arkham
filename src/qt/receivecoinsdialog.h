...
#ifndef ARKHAM_QT_RECEIVECOINSDIALOG_H
#define ARKHAM_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of arkhams */
...
#endif // ARKHAM_QT_RECEIVECOINSDIALOG_H
