...
#ifndef ARKHAM_QT_GUIUTIL_H
#define ARKHAM_QT_GUIUTIL_H
...
/** Utility functions used by the Arkham Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "arkham:" URI into recipient object, return true on successful parsing
