      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->arkhamAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->arkhamAtStartup);
    ...
    ui->arkhamAtStartup->setToolTip(ui->arkhamAtStartup->toolTip().arg(CLIENT_NAME));
    ui->arkhamAtStartup->setText(ui->arkhamAtStartup->text().arg(CLIENT_NAME));

    ui->openArkhamConfButton->setToolTip(ui->openArkhamConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new ArkhamUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->arkhamAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSARKontrols);
...
void OptionsDialog::on_openArkhamConfButton_clicked()
{
