...
//! Entry point for ArkhamApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ArkhamApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ArkhamGUI tests.
void AppTests::guiTests(ArkhamGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ArkhamGUI::consoleShown, this, &AppTests::consoleTests);
