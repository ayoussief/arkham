...
{
    // Test regression https://github.com/arkham/arkham/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/arkham-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/arkham-core/gui/pull/568.
    // With fListen=false in ~/.config/Arkham/Arkham-Qt.conf and all else left as default,
    // arkham-qt should set both -listen and -listenonion to false and start successfully.
