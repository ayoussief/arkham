...
#ifndef ARKHAM_QT_ARKHAMUNITS_H
#define ARKHAM_QT_ARKHAMUNITS_H
...
/** Arkham unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ArkhamUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ArkhamUnits(QObject *parent);
