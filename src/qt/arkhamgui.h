...
#ifndef ARKHAM_QT_ARKHAMGUI_H
#define ARKHAM_QT_ARKHAMGUI_H
...
/**
  Arkham GUI main class. This class represents the main window of the Arkham UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ArkhamGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ArkhamGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~ArkhamGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a arkham wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, ArkhamUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Arkham Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(ArkhamUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // ARKHAM_QT_ARKHAMGUI_H
