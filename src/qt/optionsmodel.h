...
#ifndef ARKHAM_QT_OPTIONSMODEL_H
#define ARKHAM_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Arkham client.
...
public:
    ...
    ArkhamUnit getDisplayUnit() const { return m_display_arkham_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSARKontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    ArkhamUnit m_display_arkham_unit;
...
Q_SIGNALS:
    void displayUnitChanged(ArkhamUnit unit);
...
#endif // ARKHAM_QT_OPTIONSMODEL_H
