...
#ifndef ARKHAM_QT_WALLETVIEW_H
#define ARKHAM_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a arkham wallet, and offers access to
