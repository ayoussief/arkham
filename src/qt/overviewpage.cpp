...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = ArkhamUnits::formatWithUnit(unit, amount, true, ArkhamUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    ArkhamUnit unit{ArkhamUnit::BTC};
...
{
    ArkhamUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(ArkhamUnits::formatWithPrivacy(unit, balances.balance, ArkhamUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(ArkhamUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, ArkhamUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(ArkhamUnits::formatWithPrivacy(unit, balances.immature_balance, ArkhamUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(ArkhamUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, ArkhamUnits::SeparatorStyle::ALWAYS, m_privacy));
