...
{
    BOOST_CHECK(TestSplitHost("www.arkhamcore.org", "www.arkhamcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.arkhamcore.org]", "www.arkhamcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.arkhamcore.org:80", "www.arkhamcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.arkhamcore.org]:80", "www.arkhamcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.arkhamcore.org:65536", "www.arkhamcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.arkhamcore.org:0", "www.arkhamcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.arkhamcore.org:", "www.arkhamcore.org:", 0, false));
}
