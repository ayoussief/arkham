// Copyright (c) 2019-2020 The Arkham Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ARKHAM_TEST_UTIL_TRANSACTION_UTILS_H
#define ARKHAM_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // ARKHAM_TEST_UTIL_TRANSACTION_UTILS_H
