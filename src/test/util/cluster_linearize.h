...
#ifndef ARKHAM_TEST_UTIL_CLUSTER_LINEARIZE_H
#define ARKHAM_TEST_UTIL_CLUSTER_LINEARIZE_H
    ...
    void Unser(Stream& s, DepGraph<SetType>& depgraph)
    {
        ...
        while (true) {
            ...
            try {
                ...
                uint64_t coded_fee;
                s >> VARINT(coded_fee);
                coded_fee &= 0xFFFFFFFFFFFFF; // Enough for fee between -21M...21M ARK.
...
#endif // ARKHAM_TEST_UTIL_CLUSTER_LINEARIZE_H
