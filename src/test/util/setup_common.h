// Copyright (c) 2015-present The Arkham Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ARKHAM_TEST_UTIL_SETUP_COMMON_H
#define ARKHAM_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/arkham/arkham/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // ARKHAM_TEST_UTIL_SETUP_COMMON_H
