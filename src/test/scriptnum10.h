...
#ifndef ARKHAM_TEST_SCRIPTNUM10_H
#define ARKHAM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Arkham Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // ARKHAM_TEST_SCRIPTNUM10_H
