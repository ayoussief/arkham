...
#ifndef ARKHAM_NODE_CONNECTION_TYPES_H
#define ARKHAM_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/arkham-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Arkham’s Peer-to-Peer Network")
...
#endif // ARKHAM_NODE_CONNECTION_TYPES_H
