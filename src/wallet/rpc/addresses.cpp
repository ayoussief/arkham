...
RPCHelpMan getnewaddress()
{
    return RPCHelpMan{
        "getnewaddress",
        "Returns a new Arkham address for receiving payments.\n"
                ...
                RPCResult{
                    RPCResult::Type::STR, "address", "The new arkham address"
                },
                RPCExamples{
...
RPCHelpMan getrawchangeaddress()
{
    return RPCHelpMan{
        "getrawchangeaddress",
        "Returns a new Arkham address, for receiving change.\n"
...
RPCHelpMan setlabel()
{
    return RPCHelpMan{
        ...
        "Sets the label associated with the given address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The arkham address to be associated with a label."},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!IsValidDestination(dest)) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Arkham address");
    }
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::ARR, "", "",
                        {
                            ...
                            {
                                {RPCResult::Type::STR, "address", "The arkham address"},
...
RPCHelpMan getaddressinfo()
{
    return RPCHelpMan{
        "getaddressinfo",
        "Return information about the given arkham address.\n"
                "Some of the information will only be present if the address is in the active wallet.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The arkham address for which to get information."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        {RPCResult::Type::STR, "address", "The arkham address validated."},
...
RPCHelpMan walletdisplayaddress()
{
    return RPCHelpMan{
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "arkham address to display"},
        },
        RPCResult{
            RPCResult::Type::OBJ,"","",
            {
