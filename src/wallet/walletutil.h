// Copyright (c) 2017-2021 The Arkham Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ARKHAM_WALLET_WALLETUTIL_H
#define ARKHAM_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! arkham from opening the wallet, thinking it was newly created, and
...
#endif // ARKHAM_WALLET_WALLETUTIL_H
