...
#ifndef ARKHAM_WALLET_WALLET_H
#define ARKHAM_WALLET_WALLET_H
...
//! Discourage users to set fees higher than this amount (in arkhams) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{COIN / 100};
//! -maxtxfee will warn if called with a higher fee than this amount (in arkhams)
...
public:
     ...
     * arkham-wallet tool code or by wallet migration code. If this is called
    ...
    /** Absolute maximum transaction fee (in arkhams) used by default for the wallet */
