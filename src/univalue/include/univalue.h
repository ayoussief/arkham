...
// Copyright 2015 Arkham Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef ARKHAM_UNIVALUE_INCLUDE_UNIVALUE_H
#define ARKHAM_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // ARKHAM_UNIVALUE_INCLUDE_UNIVALUE_H
