...
#include <algorithm>
#include <attributes.h> // Added for Arkham Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Arkham Core
#include <util/string.h> // Added for Arkham Core
...
// Added for Arkham Core. Similar to std::runtime_format from C++26.
...
// Added for Arkham Core. Wrapper for checking format strings at compile time.
