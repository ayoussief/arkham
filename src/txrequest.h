...
#ifndef ARKHAM_TXREQUEST_H
#define ARKHAM_TXREQUEST_H
 ...
 *   specific transaction. See https://arkhamcore.org/en/2024/07/03/disclose_already_asked_for.
 */
