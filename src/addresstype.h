...
#ifndef ARKHAM_ADDRESSTYPE_H
#define ARKHAM_ADDRESSTYPE_H
 ...
 *  A CTxDestination is the internal data type encoded in a arkham address
 */
...
/**
 * Generate a Arkham scriptPubKey for the given CTxDestination. Returns a P2PKH
 * script for a CKeyID destination, a P2SH script for a CScriptID, and an empty
 * script for CNoDestination.
 */
CScript GetScriptForDestination(const CTxDestination& dest);

#endif // ARKHAM_ADDRESSTYPE_H
