...
#ifndef ARKHAM_RPC_UTIL_H
#define ARKHAM_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting ARK/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1ARK/kvB.
 */
