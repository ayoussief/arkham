...
// Copyright (c) 2009-2022 The Arkham Core developers
...
static RPCHelpMan waitfornewblock()
{
    return RPCHelpMan{
        ...
        "Waits for any new block and returns useful info about it.\n"
                ...
                "\nMake sure to use no RPC timeout (arkham-cli -rpcclienttimeout=0)",
                {
        ...
        {RPCResult::Type::OBJ, "", "",
        {
            ...
            {RPCResult::Type::OBJ, "prevout", "(Only if undo information is available)",
            {
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "",
                {
                    ...
                    {RPCResult::Type::STR, "address", /*optional=*/true, "The Arkham address (only if a well-defined address exists)"},
...
static RPCHelpMan getblockstats()
{
    return RPCHelpMan{
        "getblockstats",
        "Compute per block statistics for a given window. All amounts are in arkhams.\n"
            ...
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::NUM, "avgfeerate", /*optional=*/true, "Average feerate (in arkhams per virtual byte)"},
                {RPCResult::Type::NUM, "avgtxsize", /*optional=*/true, "Average transaction size"},
                {RPCResult::Type::STR_HEX, "blockhash", /*optional=*/true, "The block hash (to check for potential reorgs)"},
                {RPCResult::Type::ARR_FIXED, "feerate_percentiles", /*optional=*/true, "Feerates at the 10th, 25th, 50th, 75th, and 90th percentile weight unit (in arkhams per virtual byte)",
                {
                ...
                {RPCResult::Type::NUM, "maxfeerate", /*optional=*/true, "Maximum feerate (in arkhams per virtual byte)"},
                {RPCResult::Type::NUM, "maxtxsize", /*optional=*/true, "Maximum transaction size"},
                {RPCResult::Type::NUM, "medianfee", /*optional=*/true, "Truncated median fee in the block"},
                {RPCResult::Type::NUM, "mediantime", /*optional=*/true, "The block median time past"},
                {RPCResult::Type::NUM, "mediantxsize", /*optional=*/true, "Truncated median transaction size"},
                {RPCResult::Type::NUM, "minfee", /*optional=*/true, "Minimum fee in the block"},
                {RPCResult::Type::NUM, "minfeerate", /*optional=*/true, "Minimum feerate (in arkhams per virtual byte)"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    for (size_t i = 0; i < block.vtx.size(); ++i) {
        ...
        if (loop_inputs) {
            ...
            // New feerate uses arkhams per virtual byte instead of per serialized byte
...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (arkham-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
...
static RPCHelpMan getdescriptoractivity()
{
    return RPCHelpMan{
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (arkham-cli -rpcclienttimeout=0)",
        {
    ...
    const std::function<void()>& interruption_point)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/arkham/arkham/pull/15606#discussion_r274479369
        //
        AssertLockHeld(::cs_main);
    ...
    const std::function<void()>& interruption_point)
{
    ...
    // See also https://github.com/arkham/arkham/issues/25675
...
static RPCHelpMan loadtxoutset()
{
    return RPCHelpMan{
        ...
        "The result is a usable arkhamd instance that is current with the network tip in a "
        ...
        "document (<https://github.com/arkham/arkham/blob/master/doc/design/assumeutxo.md>).",
        {
            {"path",
                RPCArg::Type::STR,
                RPCArg::Optional::NO,
