...
#ifndef ARKHAM_RPC_PROTOCOL_H
#define ARKHAM_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in arkhamd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Arkham is not connected
