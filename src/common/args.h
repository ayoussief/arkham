...
#ifndef ARKHAM_COMMON_ARGS_H
#define ARKHAM_COMMON_ARGS_H
...
extern const char * const ARKHAM_CONF_FILENAME;
extern const char * const ARKHAM_SETTINGS_FILENAME;
