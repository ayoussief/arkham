...
#ifndef ARKHAM_COMMON_SIGNMESSAGE_H
#define ARKHAM_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's arkham address, it must refer to a public key.
...
#endif // ARKHAM_COMMON_SIGNMESSAGE_H
