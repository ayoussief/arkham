...
#ifndef ARKHAM_TXGRAPH_H
#define ARKHAM_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvingarkham.org/t/introduction-to-cluster-linearization/1032
 *
