...
```sh
cmake --build build --target arkhamd arkham-cli
cmake --build build --target arkham-qt
cmake --build build --target bench_arkham
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:arkham/arkham.git
```
