...
Assumeutxo is a feature that allows fast bootstrapping of a validating arkhamd
instance.
...
```
$ arkham-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ arkham-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
