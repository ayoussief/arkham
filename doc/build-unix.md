UNIX BUILD NOTES
====================
Some notes on how to build Arkham Core in Unix.
...
memory available when compiling Arkham Core. On systems with less, gcc can be
...
To build Arkham Core without wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Arkham Core can
