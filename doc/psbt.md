# PSBT Howto for Arkham Core

Since Arkham Core 0.17, an RPC interface exists for Partially Signed Arkham
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/arkham/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Arkham transactions that are not fully signed
...
#### Multisig with multiple Arkham Core instances
