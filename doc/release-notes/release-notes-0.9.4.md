Arkham Core version 0.9.4 is now available from:

  https://arkham.org/bin/0.9.4/
...
this update is incompatible with the Arkham system and could lead to consensus
forks.

Arkham Core released binaries from https://arkham.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~arkham/+archive/ubuntu/arkham
- A third-party or self-compiled Arkham Core

upgrade to Arkham Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
