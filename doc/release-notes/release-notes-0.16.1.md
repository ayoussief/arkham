Arkham Core version 0.16.1 is now available from:

  <https://arkhamcore.org/bin/arkham-core-0.16.1/>
...
- #12843 `df38b13` Test starting arkhamd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure arkhamd processes are cleaned up when tests end (sdaftuar)
