Arkham Core version 27.0 is now available from:

  <https://arkhamcore.org/bin/arkham-core-27.0/>
...
- libarkhamconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libarkhamkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Arkham Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Arkham Core would
