Arkham Core version 0.9.2.1 is now available from:

  https://arkham.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ARK to 0.01 ARK
...
- Fix "Start arkham on system login"
