...
Arkham Core version 0.19.1 is now available from:

  <https://arkhamcore.org/bin/arkham-core-0.19.1/>
...
From Arkham Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Arkham Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Arkham Core does not yet change appearance when
...
- #17488 fix "arkhamd already running" warnings on macOS (fanquake)
