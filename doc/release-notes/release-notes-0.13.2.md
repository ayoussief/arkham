Arkham Core version 0.13.2 is now available from:

  <https://arkham.org/bin/arkham-core-0.13.2/>
...
- #8908 `4a974b2` Update arkham-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow arkham-tx to create v2 transactions (arkdrak)
