Arkham-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/arkham/files/Arkham/arkham-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Arkham
...
New/changed settings (command-line or arkham.conf file)
--------------------------------------------------------
