Arkham version 0.5.4 is now available for download at:
http://sourceforge.net/projects/arkham/files/Arkham/arkham-0.5.4/
...
http://gitorious.org/arkham/arkhamd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Arkham-Qt notifications under Growl 1.3.
Increase required age of Arkham-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxArkham properly when installing Arkham-Qt over it. (Windows)
