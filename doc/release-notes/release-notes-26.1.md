...
Arkham Core version 26.1 is now available from:

  <https://arkhamcore.org/bin/arkham-core-26.1/>
...
using the Linux kernel, macOS 11.0+, and Windows 7 and newer.  Arkham
