Arkham Core version *0.15.2* is now available from:

  <https://arkhamcore.org/bin/arkham-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in arkham-tx (TheBlueMatt)
