Arkham Core version 0.10.4 is now available from:

  <https://arkham.org/bin/arkham-core-0.10.4/>
...
- #6953 `43c2789` Split arkham-tx into its own package
- #6953 `dfe0d4d` Include arkham-tx binary on Debian/Ubuntu
