...
Arkham Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Arkham Core

**When configuring Arkham Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Arkham Core:
...
variables will be set when generating the Arkham Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
