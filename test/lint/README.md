...
```sh
DOCKER_BUILDKIT=1 docker build -t arkham-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/arkham -it arkham-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/arkham-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/arkham-core/leveldb-subtree.git (branch arkham-fork)
* for `src/crypto/ctaes`: https://github.com/arkham-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/arkham-core/crc32c-subtree.git (branch arkham-fork)
* for `src/minisketch`: https://github.com/arkham-core/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/arkham-core/secp256k1.git
```
