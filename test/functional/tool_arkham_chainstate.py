...
class ArkhamChainstateTest(ArkhamTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_arkham_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing arkham-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    ArkhamChainstateTest(__file__).main()
