...
class TestShell:
    """Wrapper Class for ArkhamTestFramework.

    The TestShell class extends the ArkhamTestFramework
    ...
    class __TestShell(ArkhamTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ArkhamTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # ArkhamTestFramework instances are supposed to be constructed with the path
