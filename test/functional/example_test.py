...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ArkhamTestFramework
    pass


class ExampleTest(ArkhamTestFramework):
    # Each functional test is a subclass of the ArkhamTestFramework class.
    ...
    def custom_method(self):
        ...
        ArkhamTestFramework class so other tests can use it."""
