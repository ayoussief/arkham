...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The arkhamd node closes feeler connections as soon as a version
...
class P2PAddConnections(ArkhamTestFramework):
    ...
    def run_test(self):
        ...
        # arkhamd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that arkhamd sends its own version prior to processing
