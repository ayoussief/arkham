...
Verify that a arkhamd node can use an external signer command.
...
class RPCSignerTest(ArkhamTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart arkhamd with -signer=<cmd>',
