...
class TransactionTimeRescanTest(ArkhamTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine ARK and create transactions
        ...
        # generate some ark to create transactions and check blockcount
        ...
        # send 10 ark to user's first watch-only address
        self.log.info('Send 10 ark to user')
        ...
        # send 5 ark to our second watch-only address
        self.log.info('Send 5 ark to user')
        ...
        # send 1 ark to our third watch-only address
        self.log.info('Send 1 ark to user')
