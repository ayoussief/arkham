...
By default, arkhamd will dump mempool on shutdown and
...
class MempoolPersistTest(ArkhamTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent arkhamd from writing mempool.dat to disk. Verify that `savemempool` fails")
