...
class TxnMallTest(ArkhamTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 ARK:
        ...
        # First: use raw transaction API to send 1240 ARK to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 ARK coin each
        ...
        # Node0's balance should be starting balance, plus 50ARK for another
        ...
        # Node0's total balance should be starting balance, plus 100ARK for
