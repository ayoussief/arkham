...
class SegWitTest(ArkhamTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older arkhamd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let arkhamd fill it in.
