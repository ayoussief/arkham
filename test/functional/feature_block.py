...
class FullBlockTest(ArkhamTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure arkhamd isn't accepting b26
        ...
        # Extend the b28 chain to make sure arkhamd isn't accepting b28
        ...
        # arkhamd doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #                        \-> b68 (20)
        #
        # b68 - coinbase with an extra 10 arkhams,
        #       creates a tx that has 9 arkhams from out[20] go to fees
        #       this fails because the coinbase is trying to claim 1 satoshi too much in fees
        #
        # b69 - coinbase with extra 10 arkhams, and a tx that gives a 10 satoshi fee
        #       this succeeds
        #
        ...
        #    Low-S and High-S values (whereas the arkham code has custom code which does so);
