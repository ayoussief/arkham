#!/usr/bin/env python3
# Copyright (c) 2017-2022 The Arkham Core developers
...
# The block reward of coinbaseoutput.nValue (50) ARK/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 ARK/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"arkham-cli -h\" for help or \"arkham-cli listwallets\" to see "
...
class TestArkhamCli(ArkhamTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `arkham-cli getblockchaininfo`")
        ...
        # Prevent arkham-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and arkham-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and arkham-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (ARK/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (ARK/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 ARK) to the default wallet.
            ...
            # Test arkham-cli -generate with -rpcwallet in multiwallet mode.
