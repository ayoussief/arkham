...
# Copyright 2016-present The Arkham Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for arkham utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "arkham-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./arkham-util":
        execprog = os.getenv("ARKHAMUTIL", default=execprog)
    elif testObj["exec"] == "./arkham-tx":
        execprog = os.getenv("ARKHAMTX", default=execprog)
