...
"""Example logging Arkham Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/arkhamd
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[arkhamd_with_usdts])
