...
(define* (make-arkham-cross-toolchain target
                                       #:key
...
desirable for building Arkham Core release binaries."
...
;; failure; see https://github.com/arkham/arkham/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-arkham-cross-toolchain target)))
