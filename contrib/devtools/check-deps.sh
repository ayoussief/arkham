...
declare -A LIBS
LIBS[cli]="libarkham_cli.a"
LIBS[common]="libarkham_common.a"
LIBS[consensus]="libarkham_consensus.a"
LIBS[crypto]="libarkham_crypto.a"
LIBS[node]="libarkham_node.a"
LIBS[util]="libarkham_util.a"
LIBS[wallet]="libarkham_wallet.a"
...
# https://github.com/arkham/arkham/issues/10102
