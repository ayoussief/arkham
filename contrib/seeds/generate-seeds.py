...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef ARKHAM_CHAINPARAMSSEEDS_H\n')
    g.write('#define ARKHAM_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the arkham network\n')
    ...
    g.write('#endif // ARKHAM_CHAINPARAMSSEEDS_H\n')
