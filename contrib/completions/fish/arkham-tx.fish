...
# Extract options
function __fish_arkham_tx_get_options
...
# Extract commands
function __fish_arkham_tx_get_commands
...
complete \
    --command arkham-tx \
    --condition "not __fish_arkham_seen_cmd (__fish_arkham_tx_get_commands --commandsonly)" \
    --arguments "(__fish_arkham_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command arkham-tx \
    --arguments "(__fish_arkham_tx_get_commands)" \
    --no-files
