...
complete --command arkham-qt --no-files

# Extract options
function __fish_arkhamqt_get_options
...
complete \
    --command arkham-qt \
    --arguments "(__fish_arkhamqt_get_options --nofiles)"
