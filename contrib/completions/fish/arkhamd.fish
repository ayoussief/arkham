...
complete --command arkhamd --no-files

# Extract options
function __fish_arkhamd_get_options
...
complete \
    --command arkhamd \
    --arguments "(__fish_arkhamd_get_options --nofiles)"
